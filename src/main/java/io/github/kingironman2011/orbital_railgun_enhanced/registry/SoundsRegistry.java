...
public class SoundsRegistry {
    ...
    public static final Identifier RAILGUN_SHOOT_ID = Identifier.of(MOD_ID, "railgun_shoot");
    public static final Identifier SCOPE_ON_ID = Identifier.of(MOD_ID, "scope_on");
    public static final Identifier EQUIP_ID = Identifier.of(MOD_ID, "equip");
